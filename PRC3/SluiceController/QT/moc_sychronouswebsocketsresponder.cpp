...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_SychronousWebSocketsResponder_t, stringdata) + ofs \
...
QT_MOC_LITERAL(1, 30, 9),
QT_MOC_LITERAL(2, 40, 0),
QT_MOC_LITERAL(3, 41, 12)
    },
    "SychronousWebSocketsResponder\0Connected\0"
    "\0Disconnected"
};
...
const QMetaObject SychronousWebSocketsResponder::staticMetaObject = {
    { &QThread::staticMetaObject, qt_meta_stringdata_SychronousWebSocketsResponder.data,
      qt_meta_data_SychronousWebSocketsResponder,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_SychronousWebSocketsResponder.stringdata))
